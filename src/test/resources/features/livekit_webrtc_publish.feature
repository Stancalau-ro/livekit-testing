Feature: LiveKit WebRTC Video Publishing
  ...
  Scenario: Multiple participants can join the same room and publish video
    ...
    And room "MultiRoom" is created using service "livekit"
    ...
    Then room "MultiRoom" should have 1 active participants in service "livekit"
    And participant "Jack" should be publishing video in room "MultiRoom" using service "livekit"
    ...
    Then room "MultiRoom" should have 2 active participants in service "livekit"
    And participant "Jill" should be publishing video in room "MultiRoom" using service "livekit"
    And participant "Jack" should have 1 remote video tracks available in room "MultiRoom" using service "livekit"
    And participant "Jill" should have 1 remote video tracks available in room "MultiRoom" using service "livekit"
  ...
  Scenario: Leave meeting and verify disconnection
    ...
    And room "TempRoom" is created using service "livekit"
  ...
  Scenario: Participant without publish permission can join but cannot publish video
    ...
    And room "RestrictedRoom" is created using service "livekit"
    ...
    Then room "RestrictedRoom" should have 1 active participants in service "livekit"
    And participant "Emily" should not be publishing video in room "RestrictedRoom" using service "livekit"