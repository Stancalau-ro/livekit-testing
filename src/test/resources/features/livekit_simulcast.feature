Feature: Simulcast Video Publishing
  ...
  Scenario: Non-simulcast track has single video layer
    ...
    And room "SingleLayerRoom" is created using service "livekit"
    ...
    Then room "SingleLayerRoom" should have 1 active participants in service "livekit"
    And participant "Diana" should be publishing video in room "SingleLayerRoom" using service "livekit"
    And participant "Diana" should have simulcast disabled for video in room "SingleLayerRoom" using service "livekit"
    And participant "Diana" video track should have "1" layers in room "SingleLayerRoom" using service "livekit"
  ...
  Scenario: Simulcast layers have different resolutions
    ...
    And room "QualityRoom" is created using service "livekit"
    ...
    Then room "QualityRoom" should have 1 active participants in service "livekit"
    And participant "Edward" should be publishing video in room "QualityRoom" using service "livekit"
    And participant "Edward" should have simulcast enabled for video in room "QualityRoom" using service "livekit"
    And participant "Edward" video track should have ">=2" layers in room "QualityRoom" using service "livekit"
    And participant "Edward" video layers should have different resolutions in room "QualityRoom" using service "livekit"
    And participant "Edward" highest video layer should have greater resolution than lowest layer in room "QualityRoom" using service "livekit"
  ...
  Scenario: Subscriber can set video quality preference to LOW
    ...
    And room "SubQualityRoom" is created using service "livekit"
    ...
    Then room "SubQualityRoom" should have 1 active participants in service "livekit"
    And participant "Frank" should be publishing video in room "SubQualityRoom" using service "livekit"
    And participant "Frank" should have simulcast enabled for video in room "SubQualityRoom" using service "livekit"
    ...
    Then room "SubQualityRoom" should have 2 active participants in service "livekit"
  ...
  Scenario: Subscriber can set video quality preference to HIGH
    ...
    And room "HighQualityRoom" is created using service "livekit"
    ...
    Then room "HighQualityRoom" should have 1 active participants in service "livekit"
    And participant "Henry" should be publishing video in room "HighQualityRoom" using service "livekit"
    ...
    Then room "HighQualityRoom" should have 2 active participants in service "livekit"
  ...
  Scenario: Subscriber receives lower quality under bandwidth constraints
    ...
    And room "BandwidthRoom" is created using service "livekit"
    ...
    Then room "BandwidthRoom" should have 1 active participants in service "livekit"
    And participant "Kevin" should be publishing video in room "BandwidthRoom" using service "livekit"
    And participant "Kevin" should have simulcast enabled for video in room "BandwidthRoom" using service "livekit"
    ...
    Then room "BandwidthRoom" should have 2 active participants in service "livekit"
  ...
  Scenario Outline: Participant can publish simulcast video with different browsers
    ...
    And room "BrowserRoom" is created using service "livekit"
    ...
    Then room "BrowserRoom" should have 1 active participants in service "livekit"
    And participant "Mike" should be publishing video in room "BrowserRoom" using service "livekit"
    And participant "Mike" should have simulcast enabled for video in room "BrowserRoom" using service "livekit"
