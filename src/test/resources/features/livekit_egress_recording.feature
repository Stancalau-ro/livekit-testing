Feature: LiveKit Egress Recording
  ...
  Scenario: Record video from a publisher to local file using egress
    Given the system creates room "EgressRecordingRoom" using service "livekit1"
    ...
    When the system starts room composite recording for room "EgressRecordingRoom" using LiveKit service "livekit1"
    ...
    And the system stops room composite recording for room "EgressRecordingRoom" using LiveKit service "livekit1"
  ...
  Scenario: Record specific participant tracks using track composite egress
    Given the system creates room "TrackCompositeRoom" using service "livekit1"
    ...
    And the system starts track composite recording for participant "Thomas" in room "TrackCompositeRoom" using LiveKit service "livekit1"
    Then "mockserver1" should have received an "egress_started" event for room "TrackCompositeRoom"
    
    When the recording runs for 6 seconds
    And the system stops track composite recording for participant "Thomas" using LiveKit service "livekit1"
  ...
  Scenario: Record multiple participants in the same room using egress
    Given the system creates room "MultiParticipantRecording" using service "livekit1"
    ...
    When the system starts room composite recording for room "MultiParticipantRecording" using LiveKit service "livekit1"
    Then "mockserver1" should have received an "egress_started" event for room "MultiParticipantRecording"
    
    When the recording runs for 6 seconds
    And the system stops room composite recording for room "MultiParticipantRecording" using LiveKit service "livekit1"
  ...
  Scenario: Record individual tracks from multiple participants simultaneously
    Given the system creates room "MultiTrackCompositeRoom" using service "livekit1"
    ...
    And the system starts track composite recording for participant "Alice" in room "MultiTrackCompositeRoom" using LiveKit service "livekit1"
    Then "mockserver1" should have received an "egress_started" event for room "MultiTrackCompositeRoom"
    
    When the system starts track composite recording for participant "Bob" in room "MultiTrackCompositeRoom" using LiveKit service "livekit1"
    Then "mockserver1" should have received 2 "egress_started" events for room "MultiTrackCompositeRoom"
    
    When the recording runs for 6 seconds
    And the system stops track composite recording for participant "Alice" using LiveKit service "livekit1"
    And the system stops track composite recording for participant "Bob" using LiveKit service "livekit1"
