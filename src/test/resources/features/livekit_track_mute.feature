Feature: Track Mute and Unmute Operations
  ...
  Scenario: Participant can mute and unmute audio track with server verification
    ...
    And room "AudioMuteRoom" is created using service "livekit"
    ...
    Then room "AudioMuteRoom" should have 1 active participants in service "livekit"
    And participant "Alice" should have audio track unmuted in room "AudioMuteRoom" using service "livekit"
    And "Alice" should have audio unmuted locally

    When "Alice" mutes their audio

    Then "Alice" should have audio muted locally
    And participant "Alice" should have audio track muted in room "AudioMuteRoom" using service "livekit"
  ...
  Scenario: Participant can mute and unmute video track with server verification
    ...
    And room "VideoMuteRoom" is created using service "livekit"
    ...
    Then room "VideoMuteRoom" should have 1 active participants in service "livekit"
    And participant "Bob" should be publishing video in room "VideoMuteRoom" using service "livekit"
    And participant "Bob" should have video track unmuted in room "VideoMuteRoom" using service "livekit"
    And "Bob" should have video unmuted locally

    When "Bob" mutes their video

    Then "Bob" should have video muted locally
    And participant "Bob" should have video track muted in room "VideoMuteRoom" using service "livekit"
  ...
  Scenario: Mute state propagates to other participants
    ...
    And room "PropagationRoom" is created using service "livekit"
    ...
    Then room "PropagationRoom" should have 1 active participants in service "livekit"
    And participant "Charlie" should be publishing video in room "PropagationRoom" using service "livekit"
    ...
    Then room "PropagationRoom" should have 2 active participants in service "livekit"
    And participant "Diana" should be publishing video in room "PropagationRoom" using service "livekit"

    When "Charlie" mutes their audio
    And "Charlie" mutes their video

    Then participant "Charlie" should have audio track muted in room "PropagationRoom" using service "livekit"
    And participant "Charlie" should have video track muted in room "PropagationRoom" using service "livekit"

    When "Charlie" unmutes their audio
    And "Charlie" unmutes their video

    Then participant "Charlie" should have audio track unmuted in room "PropagationRoom" using service "livekit"
    And participant "Charlie" should have video track unmuted in room "PropagationRoom" using service "livekit"
  ...
  Scenario Outline: Participant can mute and unmute audio across different browsers
    ...
    And room "BrowserMuteRoom" is created using service "livekit"
    ...
    Then room "BrowserMuteRoom" should have 1 active participants in service "livekit"
    And "Edward" should have audio unmuted locally

    When "Edward" mutes their audio

    Then "Edward" should have audio muted locally
    And participant "Edward" should have audio track muted in room "BrowserMuteRoom" using service "livekit"

    When "Edward" unmutes their audio

    Then "Edward" should have audio unmuted locally
    And participant "Edward" should have audio track unmuted in room "BrowserMuteRoom" using service "livekit"
