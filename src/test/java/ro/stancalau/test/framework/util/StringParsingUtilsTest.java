...
class StringParsingUtilsTest {
    ...
    class ParseKeyValuePairsTests {
        ...
        void shouldHandleComplexValuesWithMultipleEscapes() {
            String input = "fullname=Grace O'Connor\\, Senior Engineer,tags=test\\,debug\\,dev,department=engineering";
            Map<String, String> result = StringParsingUtils.parseKeyValuePairs(input);
        ...
        void shouldThrowExceptionForMalformedPairs() {
            ...
            IllegalArgumentException exception = assertThrows(
                ...
                () -> StringParsingUtils.parseKeyValuePairs(input)
            );
    ...
    class IntegrationTests {
        ...
        void shouldHandleRealWorldAttributesParsingScenario() {
            String attributesInput = "role=moderator,department=engineering,description=A room for testing\\, debugging\\, and development,fullname=Grace O'Connor\\, Senior Engineer";
