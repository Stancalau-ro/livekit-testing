...
/**
 * Factory for creating LiveKit containers with configurable versions. This factory is responsible
 * for version selection and delegates container creation to LiveKitContainer which handles the
 * container lifecycle.
 */
@Slf4j
@UtilityClass
public class LiveKitContainerFactory {
  ...
  public static LiveKitContainer createContainer(
      String alias, Network network, String livekitVersion, @Nullable String configFilePath) {
    log.debug(
        "Creating LiveKit container '{}' with version '{}' and config '{}'",
        alias,
        livekitVersion,
        configFilePath);
  ...
  public static LiveKitContainer createContainer(
      String alias, Network network, @Nullable String configFilePath) {
  ...
  public static LiveKitContainer createContainer(Network network, @Nullable String configFilePath) {
    String version = TestConfig.getLiveKitVersion();
    log.info(
        "Creating default LiveKit container with configured version '{}' and config '{}'",
        version,
        configFilePath);
  ...
  public static LiveKitContainer createBddContainer(
      String alias, Network network, @Nullable String configFilePath) {
    String version = TestConfig.getLiveKitVersion();
    log.info(
        "Creating BDD LiveKit container '{}' with version '{}' and config '{}'",
        alias,
        version,
        configFilePath);
    return createContainer(alias, network, version, configFilePath);
  ...
  public static LiveKitContainer createBddContainerWithScenarioLogs(
      String alias, Network network, @Nullable String configFilePath, String logDestinationPath) {
    String version = TestConfig.getLiveKitVersion();
    log.info(
        "Creating BDD LiveKit container '{}' with version '{}', config '{}', and log destination '{}'",
        alias,
        version,
        configFilePath,
        logDestinationPath);
    return LiveKitContainer.createContainer(
        alias, network, version, configFilePath, logDestinationPath);
  }
  ...
  public static LiveKitContainer createIntegrationTestContainer(String alias, Network network) {
    ...
    log.info(
        "Creating integration test LiveKit container '{}' with version '{}', config '{}', and log path '{}'",
        alias,
        version,
        configPath,
        integrationLogPath);
    return LiveKitContainer.createContainer(
        alias, network, version, configPath, integrationLogPath);
  }

  /** Creates a LiveKit container for integration tests without config file */
  public static LiveKitContainer createIntegrationTestContainerWithoutConfig(
      String alias, Network network) {
    String version = TestConfig.getLiveKitVersion();
    ...
    log.info(
        "Creating integration test LiveKit container '{}' with version '{}' (no config) and log path '{}'",
        alias,
        version,
        integrationLogPath);
