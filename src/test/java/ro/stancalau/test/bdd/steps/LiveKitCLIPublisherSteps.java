...
public class LiveKitCLIPublisherSteps {
    ...
    public void theCLILoadTestForRoomShouldCompleteSuccessfullyWithinSeconds(String roomName, int timeoutSeconds)
    ...
    private void startJoinPublisher(
            String identity, String roomName, String serviceName, boolean publishVideo, boolean publishAudio) {
        Network network = ManagerProvider.containers().getOrCreateNetwork();
        LiveKitContainer liveKitContainer =
                ManagerProvider.containers().getContainer(serviceName, LiveKitContainer.class);
