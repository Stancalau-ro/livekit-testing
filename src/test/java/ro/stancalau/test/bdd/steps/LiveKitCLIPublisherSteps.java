...
public class LiveKitCLIPublisherSteps {
  ...
  @Given(
      "a CLI load test publisher with {int} video publishers connects to room {string} using service {string}")
  public void aCLILoadTestPublisherWithVideoPublishersConnectsToRoom(
      int videoPublishers, String roomName, String serviceName) {
    startLoadTestPublisher(serviceName, roomName, videoPublishers, 0, 0, null);
  }

  @Given(
      "a CLI load test publisher with {int} audio publishers connects to room {string} using service {string}")
  public void aCLILoadTestPublisherWithAudioPublishersConnectsToRoom(
      int audioPublishers, String roomName, String serviceName) {
    startLoadTestPublisher(serviceName, roomName, 0, audioPublishers, 0, null);
  }

  @Given(
      "a CLI load test with {int} video publishers and {int} subscribers connects to room {string} using service {string}")
  public void aCLILoadTestWithVideoPublishersAndSubscribersConnectsToRoom(
      int videoPublishers, int subscribers, String roomName, String serviceName) {
  ...
  public void aCLILoadTestWithConfigConnectsToRoom(
      String configString, String roomName, String serviceName) {
    ...
    CLIPublisherContainer.PublisherConfig.Builder builder =
        CLIPublisherContainer.PublisherConfig.builder();
  ...
  public void startsACLIPublisherWithMediaToRoomUsingService(
      String identity, String mediaType, String roomName, String serviceName) {
    ...
    switch (mediaType.toLowerCase()) {
      ...
      default:
        throw new IllegalArgumentException(
            "Invalid media type: " + mediaType + ". Valid options are: 'audio', 'video', 'a/v'");
    }
  ...
  public void startsACLIPublisherToRoomUsingService(
  ...
  public void startsACLIVideoOnlyPublisherToRoomUsingService(
      String identity, String roomName, String serviceName) {
  ...
  public void startsACLIAudioOnlyPublisherToRoomUsingService(
      String identity, String roomName, String serviceName) {
  ...
  public void theCLILoadTestForRoomShouldCompleteSuccessfullyWithinSeconds(
      String roomName, int timeoutSeconds) throws InterruptedException {
    String containerAlias = "cli-load-test-" + roomName.toLowerCase();
    CLIPublisherContainer container =
        ManagerProvider.containers().getContainer(containerAlias, CLIPublisherContainer.class);
    ...
    assertTrue(
        !container.isRunning() || waited < timeoutSeconds,
  ...
  public void theCLIPublisherShouldBeConnectedToRoom(String identity, String roomName) {
    ...
    CLIPublisherContainer container =
        ManagerProvider.containers().getContainer(containerName, CLIPublisherContainer.class);
  ...
  private void startLoadTestPublisher(
      String serviceName,
      String roomName,
      int videoPublishers,
      int audioPublishers,
  ...
  private void startLoadTestPublisher(
      String serviceName, String roomName, CLIPublisherContainer.PublisherConfig config) {
    ...
    CLIPublisherContainer cliContainer =
        CLIPublisherContainer.createLoadTestContainer(
  ...
  private void startJoinPublisher(
      String identity,
      String roomName,
      String serviceName,
      boolean publishVideo,
    ...
    if (cliPublisherCount > 1) {
      try {
        ...
        log.info(
            "Adding {} second delay before starting CLI publisher {} (count: {})",
            delaySeconds,
            identity,
            cliPublisherCount);
    ...
    CLIPublisherContainer cliContainer =
        CLIPublisherContainer.createJoinContainer(
            containerAlias,
            network,
            wsUrl,
            apiKey,
    ...
    cliContainer.start();
    log.info(
        "Started CLI publisher for {} in room {} (video: {}, audio: {})",
        identity,
        roomName,
        publishVideo,
        publishAudio);
