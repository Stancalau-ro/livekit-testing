...
public class LiveKitMetadataSteps {
    ...
    public void verifyRoomMetadata(String roomName, String expectedMetadata, String serviceName) {
        boolean success =
                ManagerProvider.metadata().pollUntilRoomMetadataEquals(serviceName, roomName, expectedMetadata);
    ...
    public void verifyRoomMetadataEmpty(String roomName, String serviceName) {
        String metadata = BrowserPollingHelper.pollUntil(
                () -> ManagerProvider.metadata().getRoomMetadata(serviceName, roomName), m -> m == null || m.isEmpty());
        assertTrue(
    ...
    public void verifyRoomMetadataLength(String roomName, int expectedLength, String serviceName) {
        ...
        assertEquals(expectedLength, metadata.length(), "Room metadata length should be " + expectedLength);
    }
    ...
    public void verifyRetrievedRoomInfoEmptyMetadata() {
        ...
        assertTrue(metadata == null || metadata.isEmpty(), "Retrieved room info should have empty metadata");
    }
    ...
    public void verifyParticipantMetadata(
        ...
        boolean success = ManagerProvider.metadata()
    ...
    public void verifyParticipantMetadataEvent(String participantName, String targetIdentity, String expectedValue) {
        boolean received = ManagerProvider.metadata()
    ...
    public void verifyBrowserRoomMetadata(String participantName, String expectedMetadata) {
        String actual = BrowserPollingHelper.pollUntil(
                () -> ManagerProvider.metadata().getCurrentRoomMetadataFromBrowser(participantName),
                expectedMetadata::equals);
        assertEquals(expectedMetadata, actual, participantName + " should see room metadata: " + expectedMetadata);
    }
    ...
    public void verifyParticipantMetadataApproximateSize(
        ...
        assertTrue(
                ...
                "Metadata length should be approximately " + expectedBytes + " bytes (got " + metadata.length() + ")");
    }
}
