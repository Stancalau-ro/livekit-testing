...
public class ScreenShareSteps {
    ...
    public void participantShouldNotBeAbleToShareScreenDueToPermissions(String participantName) {
        ...
        assertTrue(
                isBlocked || !isSharing,
                participantName
                        + " should not be able to share screen (blocked: "
                        + isBlocked
                        + ", sharing: "
                        + isSharing
                        + ")");
    ...
    public void participantShouldNotBeAbleToSubscribeToVideoDueToPermissions(String participantName) {
        ...
        assertTrue(
                hasSubscriptionFailures || hasNoVideoPlayback,
                participantName
                        + " should not be able to subscribe to video (failedEvents: "
                        + subscriptionFailedCount
                        + ", permissionDenied: "
                        + permissionDenied
                        + ", playingVideos: "
                        + playingVideoElements
                        + ", subscribedTracks: "
                        + subscribedTracks
                        + ", error: '"
                        + errorMessage
