...
public class VideoRecordingEgressSteps {
    ...
    public void aMinIOServerIsRunningInContainer(String serviceName) {
        aMinIOServerIsRunningInContainerWithCredentials(serviceName, MinIOContainer.DEFAULT_ACCESS_KEY, MinIOContainer.DEFAULT_SECRET_KEY);
    }

    @Given("a MinIO server is running in a container with service name {string} with access key {string} and secret key {string}")
    public void aMinIOServerIsRunningInContainerWithCredentials(String serviceName, String accessKey, String secretKey) {
        ContainerStateManager containerManager = ManagerProvider.getContainerManager();
    ...
    public void stopTrackCompositeRecording(String participantIdentity, String livekitServiceName) throws Exception {
        ...
        stopEgressRecording(egressId, livekitServiceName, participantIdentity + "_track",
    ...
    public void stopRoomCompositeRecording(String roomName, String livekitServiceName) throws Exception {
        ...
        stopEgressRecording(egressId, livekitServiceName, roomName,
                "room composite recording for room " + roomName);
    }
    ...
    public void verifyTrackCompositeRecordingFileExistsInMinIOWithPrefix(String bucketName, String prefix, String participantIdentity) throws InterruptedException {
        verifyS3RecordingFile(bucketName, prefix, "track-composite-" + participantIdentity, "participant " + participantIdentity);
    }
    ...
    private void startTrackCompositeRecordingToLocal(String participantIdentity, String roomName, String livekitServiceName) throws Exception {
        ContainerStateManager containerManager = ManagerProvider.getContainerManager();
        LiveKitContainer liveKitContainer = containerManager.getContainer(livekitServiceName, LiveKitContainer.class);
    ...
    private void startEgressRecording(EgressServiceClient egressClient, String roomName, LivekitEgress.EncodedFileOutput fileOutput, String outputType) throws Exception {
        LivekitEgress.EgressInfo egressInfo;
        try {
        ...
        EgressTestUtils.waitForEgressToBeActive(egressClient, egressId, roomName);
        log.info("Started room composite recording for room {} with egress ID: {} to {}", roomName, egressId, outputType);
    }

    private void stopEgressRecording(String egressId, String livekitServiceName, String stateKey, String description) throws Exception {
        ContainerStateManager containerManager = ManagerProvider.getContainerManager();
        LiveKitContainer liveKitContainer = containerManager.getContainer(livekitServiceName, LiveKitContainer.class);
    ...
    private void verifyLocalRecordingFile(String filePattern, String description) throws InterruptedException {
        ...
        assertNotNull(recordingFile, "No recording files found for " + description +
                " after 10 attempts. Files in directory: " + String.join(", ", recordingsDir.list()));
    ...
    private void verifyS3RecordingFile(String bucketName, String prefix, String filePattern, String description) throws InterruptedException {
        ContainerStateManager containerManager = ManagerProvider.getContainerManager();
        MinIOContainer minioContainer = containerManager.getContainer("minio", MinIOContainer.class);
        ...
        assertNotNull(recordingKey, "No recording files found in S3 bucket " + bucketName +
                " for " + description + " after 20 attempts");
    ...
    private String pollForS3Object(MinioS3Client s3Client, String prefix, String pattern, int maxAttempts) throws InterruptedException {
        int attempt = 0;
    ...
    private LivekitEgress.S3Upload createS3Upload(MinIOContainer minioContainer, String bucketName, String roomName, String timestamp) {
