...
public final class FileUtils {
    ...
    public static String sanitizeFileName(String fileName) {
        ...
        return fileName.replaceAll("[^a-zA-Z0-9\\-_\\s]", "_") // Convert invalid chars to underscores, keep spaces
    ...
    public static String sanitizeFileNameStrict(String fileName) {
        ...
        return fileName.replaceAll("[^a-zA-Z0-9._-]", "_") // Convert invalid chars (including spaces) to underscores
                .replaceAll("_+", "_") // Convert multiple underscores to single underscore
                .replaceAll("^_|_$", ""); // Remove leading/trailing underscores
    }
