...
public final class FileUtils {
     ...
     * This method preserves spaces and converts them to underscores, while removing other invalid characters.
     * 
    ...
    public static String sanitizeFileNameStrict(String fileName) {
        ...
        return fileName
                .replaceAll("[^a-zA-Z0-9._-]", "_")     // Convert invalid chars (including spaces) to underscores
                .replaceAll("_+", "_")                  // Convert multiple underscores to single underscore
                .replaceAll("^_|_$", "");               // Remove leading/trailing underscores
    }
