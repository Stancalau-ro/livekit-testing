...
public class DateUtils {
    ...
    /**
     * Formatter for scenario timestamps used in log directory names.
     * Pattern: yyyy-MM-dd_HH-mm-ss
     * Example: 2025-08-06_13-25-59
     */
    public static final DateTimeFormatter SCENARIO_TIMESTAMP_FORMAT = DateTimeFormatter.ofPattern("yyyy-MM-dd_HH-mm-ss");

    /**
     * Formatter for recording file timestamps used in recording filenames.
     * Pattern: yyyy-MM-dd'T'HHmmss (ISO-like format without separators)
     * Example: 2025-08-06T132559
     */
    public static final DateTimeFormatter RECORDING_TIMESTAMP_FORMAT = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HHmmss");

    /**
     * Generates a scenario timestamp string using the current date and time.
     * Used for creating scenario-specific log directories.
     * 
    ...
    /**
     * Generates a recording timestamp string using the current date and time.
     * Used for creating unique recording filenames.
     * 
