...
/**
 * S3 client wrapper specifically designed for MinIO integration testing.
 * Provides S3-compatible operations for bucket management, object operations,
 * and content validation in test environments.
 */
@Slf4j
