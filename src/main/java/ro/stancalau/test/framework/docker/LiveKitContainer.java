    ...
    public static LiveKitContainer createContainer(
        ...
        if (configFilePath != null && !configFilePath.isEmpty()) {
            ...
            if (configFile.exists()) {
                container = container
                        .withFileSystemBind(configFile.getAbsolutePath(), "/config.yaml", BindMode.READ_ONLY)
        ...
        outputDir.mkdirs();
        container = container.withFileSystemBind(outputDir.getAbsolutePath(), "/out", BindMode.READ_WRITE);
