...
public class DataChannelStateManager {
  ...
  public void sendTargetedMessage(
      String sender, String message, String recipient, boolean reliable) {
  ...
  public boolean hasReceivedMessage(String receiver, String message, String sender) {
    ...
    return meetInstance.hasReceivedDataMessage(
        message, sender, LiveKitMeet.DEFAULT_DATA_MESSAGE_TIMEOUT_MS);
  }
